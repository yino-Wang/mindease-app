      ...
      <main className="flex max-w-md flex-col items-center gap-10 text-center">
        ...
        {isAuthenticated ? (
          <div className="flex flex-col items-center gap-4">
            ...
            <Link
              href="/courses"
              className="rounded-full border border-stone-700/60 px-8 py-3 font-serif text-sm tracking-widest text-stone-400 transition-all duration-700 ease-in-out hover:border-stone-600 hover:text-stone-300"
            >
              Begin 3-Day Journey
            </Link>
          </div>
